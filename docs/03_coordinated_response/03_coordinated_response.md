...
You understand the attack. In Exercise 01 you pulled scattered alerts into one cross-domain narrative; in Exercise 02 you reconstructed the full lifecycle from telemetry and marked every point where detection and response should have fired. The chain is no longer a mystery — it is a known sequence that touched **identity, data/AI, and infrastructure**.
